...
** entry
   #+BEGIN_SRC emacs-lisp
     (let ((sys system-type))
       (cond
	((eq sys 'darwin) (add-to-list 'load-path "~/.emacs.d/lisp/"))
	((eq sys 'windows-nt) (add-to-list 'load-path "e:/emacs/.emacs.d/lisp/"))))
   #+END_SRC
** use-package
   #+BEGIN_SRC emacs-lisp
  ;; Add use-package
    ...
    (setq org-agenda-files (list (concat org-directory "inbox.org"))
	  ...
	  `(("i" "Inbox" entry (file+headline ,(concat org-directory "inbox.org") "Inbox:")
	    ...
	    ("j" "Journal" entry (file+datetree ,(concat org-directory "journal.org"))
	     "* %U\n%?")
	    ("a" "Arrangement" entry (file+headline ,(concat org-directory "todo.org") "Arrangement:")
	     "* %? %^T")
	    ("t" "Todo")
	    ("tt" "Todo without time" entry (file+headline ,(concat org-directory "todo.org") "Todo:")
	     "* TODO %?")
	    ("ts" "Todo with SCHEDULED" entry (file+headline ,(concat org-directory "todo.org") "Todo:")
	     "* TODO %?\nSCHEDULED:%^t")
	    ("td" "Todo with DEADLINE" entry (file+headline ,(concat org-directory "todo.org") "Todo:")
	     "* TODO %?\nDEADLINE:%^t"))
	  ;; org-refile-targets
